...
class FunCmds(
    ...
    @vbot.group(
        name="copycat",
        description="Cosplay đứa mày ghét xD",
    ...
    @vbot.command(
        name="stealpfp",
        description="Cosplay bằng cách đổi avatar theo nó (Sau 2-3 lần là dính limit.)",
    ...
    @vbot.command(
        name="tokengrab",
        description="Trôm token của ai đó. Đừng sài nó ở chốn đông người !!",
