class config:
    global token; token = "MzkxNzYwNTUxMDQ0MTg2MTE0.G5UfY-.Op1PC0YHQq78BXZvzZ_eaAMa7l2jcu5Ebs3gvY" # Your account token
    ...
    global snipers; snipers = {
        ...
        "keyword_sniper": {
            "enabled": False, # If to log keywords
            ...
            "ignore_self": False, # If to ignore keywords sent by you
            "keywords": [
                "keyword 1",
                "keyword 2",
                "keyword 3"
